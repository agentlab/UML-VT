...
public class ExampleProject extends Wizard implements INewWizard {

	protected ExamplesPage page;
	...
	public boolean performFinish() {
		...
		IProject project  = root.getProject(page.getText1());
		...
		if (page.getSelection().equals("infusion pump")) {
			f4 = new File(getFileLoc("Infusion_Pump/model.di"));
			f5 = new File(getFileLoc("Infusion_Pump/model.notation"));
			f6 = new File(getFileLoc("Infusion_Pump/model.uml"));

		} 

		else if (page.getSelection().equals("simple model")) {
			f4 = new File(getFileLoc("Simple_Model/model.di"));
			f5 = new File(getFileLoc("Simple_Model/model.notation"));
			f6 = new File(getFileLoc("Simple_Model/model.uml"));
